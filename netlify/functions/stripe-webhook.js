...
// Atomarno številčenje – RPC increment_invoice_counter(y int) v Supabase
async function nextInvoiceNo() {
  const year = new Date().getFullYear();
  // zagotovimo obstoj vrstice za leto (idempotentno)
...
exports.handler = async (event) => {
  try {
    ...
    // — vnos v tickets (dodamo tudi created_at za analitiko) —
