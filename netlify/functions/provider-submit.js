...
// [CHG] requireFields: za storitve ne zahtevamo start/end; za "unlimited" zahtevamo telefon
function requireFields(p){
  ...
  if (!isService) {
    ...
    // če je scheduled, termini se shranijo posebej – tu jih ne zahtevamo
  }
...
export const handler = async (event) => {
  ...
  // [CHG] povsem ohranjeno: kupon pri nas stane 2 €
  ...
  try{
    // Kupon normalizacija (ostane enako)
    if ((payload.offerType || payload.saleType) === 'coupon'){
