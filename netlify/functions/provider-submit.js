  ...
  try{
    ...
    if (!BREVO_API_KEY) {
      ...
      try{
        ...
        // bulletproof button (Outlook) + plaintext fallback
        const btn = (url, label) => `
          <!--[if mso]>
          <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="${url}" style="height:42px;v-text-anchor:middle;width:220px;" arcsize="50%" stroke="f" fillcolor="${primary}">
            <w:anchorlock/>
          ...
          <a href="${url}" target="_blank" rel="noopener noreferrer"
             style="display:inline-block;background:${primary};color:#fff;text-decoration:none;font-weight:800;
                    padding:12px 18px;border-radius:999px;min-width:220px;text-align:center;">
            ${label}
          </a>
          <!--<![endif]-->
