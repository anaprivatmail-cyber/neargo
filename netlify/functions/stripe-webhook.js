...
async function createInvoicePdf({ seqNo, buyer, totalGross, base, tax, paidAt, sessionId, type }) {
  ...
  if (type === "coupon") {
    y -= 14;
    line("Opomba: kupon stane 2 €; njegova vrednost (popust, znesek ali gratis)", 9, F_REG, rgb(0.35,0.35,0.35));
    line("se unovči pri organizatorju in ni zamenljiva za denar.", 9, F_REG, rgb(0.35,0.35,0.35));
  }
