          ...
          <div style="max-width:680px;margin:0 auto;border:1px solid #e3eef7;border-radius:14px;overflow:hidden;background:#fff">
            ...
            <div style="padding:20px 22px;color:#0b1b2b">
              ...
              <p style="margin:12px 0">
                ...
                Kodo lahko odprete tudi <a href="${redeemUrl}" style="color:${primary};font-weight:800">tukaj</a>.
              </p>

              <div style="margin:10px 0 14px">
                <a href="${redeemUrl}"
                   style="display:inline-block;background:${primary};color:#fff;text-decoration:none;padding:10px 14px;border-radius:10px;font-weight:800">Odpri kodo</a>
                <span style="display:inline-block;margin-left:10px;color:#5b6b7b">Račun <b>${seq}</b> je priložen kot PDF.</span>
              </div>
