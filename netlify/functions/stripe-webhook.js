...
// (Noto Sans TTF ali fallback Helvetica), shranimo v Supabase Storage
// in pošljemo e-pošto kupcu (QR + račun).
// ———————————————————————————————————————————————————————————————
...
// DDV stopnja: robustno preberi število (tudi če je decimalno z vejico)
const TAX_RATE = (() => {
...
exports.handler = async (event) => {
  try {
    ...
    // ✅ NOVO: prijaznejši subject in uvod za e-pošto
