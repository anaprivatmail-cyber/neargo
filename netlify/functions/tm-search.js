...
function normalizeSB(obj) {
  // To je JSON, ki ga shranjuje tvoja provider-submit funkcija
  ...
  return {
    ...
    url: obj.url || null,
    images: [], // (sliko lahko dodaš kasneje)
...
export const handler = async (event) => {
  ...
  try {
    ...
    if (TM_KEY && center) {
      ...
      // rudimentaren page/size (TM ima svoj paging)
    ...
    // list all objects under submissions/
