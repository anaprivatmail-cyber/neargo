...
function render(){
  ...
  if (!root) return;
    ...
    root.innerHTML = `
      <button class="nea-fab" aria-label="${t('nea')} – ${t('help')}" tabindex="0" type="button" style="background:${BRAND_COLOR}">
        <img src="assets/nea-avatar.svg" alt="Nea AI" style="width:38px;height:38px;display:block;" />
      </button>
